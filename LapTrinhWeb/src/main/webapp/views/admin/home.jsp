				...
				<div class="icon-card mb-30">
					...
					<div class="content">
						...
						<p class="text-sm text-success">
							<i class="lni lni-arrow-up"></i> +2.00% <span class="text-gray">(30
								days)</span>
						</p>
					</div>
				</div>
			...
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<div class="icon-card mb-30">
					...
					<div class="content">
						...
						<p class="text-sm text-success">
							<i class="lni lni-arrow-up"></i> +5.45% <span class="text-gray">Increased</span>
						</p>
					</div>
				</div>
				<!-- End Icon Cart -->
				...
				<div class="icon-card mb-30">
					...
					<div class="content">
						...
						<p class="text-sm text-danger">
							<i class="lni lni-arrow-down"></i> -2.00% <span class="text-gray">Expense</span>
						</p>
					</div>
				</div>
				<!-- End Icon Cart -->
			...
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<div class="icon-card mb-30">
					...
					<div class="content">
						...
						<h3 class="text-bold mb-10">34567</h3>
						<p class="text-sm text-danger">
							<i class="lni lni-arrow-down"></i> -25.00% <span
								class="text-gray"> Earning</span>
						</p>
					</div>
				</div>
				<!-- End Icon Cart -->
		...
		<div class="row">
			<div class="col-lg-7">
				<div class="card-style mb-30">
					...
					<div class="chart">
						<canvas id="Chart1"
							style="width: 719px; height: 400px; margin-left: -35px; display: block; box-sizing: border-box;"
							width="719" height="400"></canvas>
					</div>
					<!-- End Chart -->
				</div>
			</div>
			...
			<div class="col-lg-5">
				<div class="card-style mb-30">
					...
					<div class="chart">
						<canvas id="Chart2"
							style="width: 729px; height: 400px; margin-left: -45px; display: block; box-sizing: border-box;"
							width="729" height="400"></canvas>
					</div>
					<!-- End Chart -->
				</div>
			</div>
			...
			<div class="col-lg-5">
				<div class="card-style mb-30">
					...
					<div id="map" style="width: 100%; height: 400px; overflow: hidden"
						class="jvm-container">
						<svg width="351" height="400">
                    <defs></defs>
                    <g id="jvm-regions-group"
								transform="scale(0.39) translate(0, 221.28038677454308)">
                      <path
								...
								data-code="BD" fill="#d1d5db" fill-opacity="1" stroke="none"
                      ...
                      <path
								...
								data-code="BE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="BF" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="BG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="BA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M707.48,403.47l0.69,-0.65l1.41,-0.91l-0.15,1.64l-0.81,-0.05l-0.61,0.58l-0.53,-0.6Z"
								data-code="BN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="BO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="JP" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M495.45,425.39l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.37Z"
								data-code="BI" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="BW" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="BR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="RS" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M734.55,437.87l-0.09,-0.98l4.5,-0.86l-2.82,1.28l-1.59,0.55Z"
								data-code="TL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TJ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="RO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GW" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M448.79,409.52l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
								data-code="GQ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GY" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GB" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="GH" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="OM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="JO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="HR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="HT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="HU" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="PT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="PG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="PE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="PK" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="PH" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="PL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ZM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="EH" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="EE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="EG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ZA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="EC" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="VN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SB" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ET" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ZW" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ES" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ER" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M468.91,298.06l-1.24,-1.13l0.5,-2.11l0.88,-0.81l2.29,1.73l-0.52,0.71l-0.77,-0.3l-1.14,1.91Z"
								data-code="ME" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MD" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="UZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ML" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="MR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="UG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MY" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MX" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="FI" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="FJ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="FK" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NI" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M839.03,452.86l0.23,1.16l-0.44,0.03l-0.2,-1.47l0.42,0.28Z"
								data-code="VU" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M838.79,471.67l-0.34,0.23l-2.9,-1.8l-3.27,-3.48l1.65,0.85l4.86,4.19Z"
								data-code="NC" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="NP" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M472.78,298.18l-1.1,-1.47l0.98,-0.9l0.29,-0.94l2.0,1.84l-0.4,0.85l-1.77,0.62Z"
								data-code="XK" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CI" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CH" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M504.86,320.38l0.39,0.01l0.27,-0.07l-0.3,0.35l-0.36,-0.28Z"
								data-code="XC" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CF" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CD" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M504.35,321.02l0.49,0.34l-1.34,0.65l-0.91,-0.29l-0.26,-0.55l2.02,-0.14Z"
								data-code="CY" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="CU" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M500.35,482.11l0.5,2.14l-0.39,0.94l-1.04,0.22l-1.23,-1.25l-0.02,-0.69l0.84,-1.65l1.34,0.28Z"
								data-code="SZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SY" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
                      ...
                      <path
								...
								data-code="SS" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="KH" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M195.8,379.9l1.41,-1.21l2.24,1.46l0.98,-0.27l0.44,0.21l-0.27,1.07l-1.14,-0.03l-3.65,-1.23Z"
								data-code="SV" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SK" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="KR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SI" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="KP" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M540.8,336.41l0.38,0.92l-0.17,0.78l0.61,1.64l-0.95,0.04l-0.83,-1.35l-1.59,-0.2l1.34,-2.02l1.21,0.17Z"
								data-code="KW" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="KZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="SD" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="DO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="DJ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="DK" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="DE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="YE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="DZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="US" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="UY" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M510.37,325.96l-0.89,0.55l1.84,-3.86l0.6,0.08l0.24,0.7l-1.15,0.96l-0.64,1.57Z"
								data-code="LB" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="LA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M724.01,356.0l-0.73,1.52l-0.9,-1.56l-0.26,-1.81l1.38,-2.53l1.73,-1.8l0.64,0.46l-1.86,5.73Z"
								data-code="TW" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M266.64,389.17l0.28,-1.17l1.13,-0.22l-0.06,1.21l-1.35,0.18Z"
								data-code="TT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M624.16,398.87l-1.82,0.48l-0.99,-1.67l-0.42,-3.47l0.95,-3.45l1.21,0.98l2.26,4.21l-0.34,2.34l-0.85,0.58Z"
								data-code="LK" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="LV" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="LT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M436.07,271.5l-0.48,-0.1l0.29,-1.66l0.29,0.51l-0.1,1.25Z"
								data-code="LU" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="LR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M491.05,494.85l-0.48,0.15l-1.5,-1.78l1.12,-1.53l2.18,-1.51l1.52,1.34l-0.99,1.94l-1.23,0.4l-0.62,0.98Z"
								data-code="LS" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TH" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M596.66,558.28l-3.18,0.21l-0.05,-1.59l0.4,-1.7l1.28,0.9l2.08,0.42l-0.53,1.76Z"
								data-code="TF" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TG" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TD" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="LY" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="VE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AF" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IQ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IS" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AM" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AL" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AO" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AR" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AU" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AT" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IN" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="TZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="AZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="IE" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="ID" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="UA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								d="M549.32,350.8l-0.76,-0.24l-0.14,-1.72l0.84,-1.35l0.47,0.54l0.04,1.41l-0.45,1.36Z"
								data-code="QA" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                      <path
								...
								data-code="MZ" fill="#d1d5db" fill-opacity="1" stroke="none"
								stroke-width="0" fill-rule="evenodd"
								class="jvm-region jvm-element"></path>
                    </g>
                    ...
                    <g id="jvm-markers-group">
                      <circle data-index="0" cx="194.25259140439735"
								cy="220.86285609060167" r="7" fill="#4A6CF7" fill-opacity="1"
								stroke="#FFF" stroke-width="5" stroke-opacity="0.5"
								class="jvm-marker jvm-element"></circle>
                      <circle data-index="1" cx="267.0229985967736"
								cy="171.33168101488457" r="7" fill="#ff5050" fill-opacity="1"
								stroke="#FFF" stroke-width="5" stroke-opacity="0.5"
								class="jvm-marker jvm-element"></circle>
                      <circle data-index="2" cx="60.31665514415119"
								cy="181.5319239049366" r="7" fill="#4A6CF7" fill-opacity="1"
								stroke="#FFF" stroke-width="5" stroke-opacity="0.5"
								class="jvm-marker jvm-element"></circle>
                      <circle data-index="3" cx="122.56568898587506"
								cy="145.87972766448672" r="7" fill="#4A6CF7" fill-opacity="1"
								stroke="#FFF" stroke-width="5" stroke-opacity="0.5"
								class="jvm-marker jvm-element"></circle>
                      <circle data-index="4" cx="113.4630770011128"
								cy="262.1143443397806" r="7" fill="#ff5050" fill-opacity="1"
								stroke="#FFF" stroke-width="5" stroke-opacity="0.5"
								class="jvm-marker jvm-element"></circle>
                    </g>
                    <g id="jvm-markers-labels-group">
                      <text data-index="0" x="206.25259140439735"
								y="220.86285609060167" dy="0.6ex" font-family="Verdana"
								font-size="14" font-weight="400" cursor="default" fill="#374151"
								class="jvm-marker jvm-element">
                        Egypt
                      </text>
                      <text data-index="1" x="279.0229985967736"
								y="171.33168101488457" dy="0.6ex" font-family="Verdana"
								font-size="14" font-weight="400" cursor="default" fill="#374151"
								class="jvm-marker jvm-element">
                        Russia
                      </text>
                      <text data-index="2" x="72.31665514415118"
								y="181.5319239049366" dy="0.6ex" font-family="Verdana"
								font-size="14" font-weight="400" cursor="default" fill="#374151"
								class="jvm-marker jvm-element">
                        Canada
                      </text>
                      <text data-index="3" x="134.56568898587506"
								y="145.87972766448672" dy="0.6ex" font-family="Verdana"
								font-size="14" font-weight="400" cursor="default" fill="#374151"
								class="jvm-marker jvm-element">
                        Greenland
                      </text>
                      <text data-index="4" x="125.4630770011128"
								y="262.1143443397806" dy="0.6ex" font-family="Verdana"
								font-size="14" font-weight="400" cursor="default" fill="#374151"
								class="jvm-marker jvm-element">
                        Brazil
                      </text>
								...
								<tr>
									...
									<td>
										<div class="product">
											<div class="image">
												<img
													src="${contextPath}/templates/admin/assets/images/products/product-mini-1.jpg"
													alt="" />
											</div>
									...
									<td>
										<div class="action justify-content-end">
											...
											<ul class="dropdown-menu dropdown-menu-end"
												...
												<li class="dropdown-item"><a href="#0"
													class="text-gray">Remove</a></li>
												<li class="dropdown-item"><a href="#0"
													class="text-gray">Edit</a></li>
											</ul>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="product">
											<div class="image">
												<img
													src="${contextPath}/templates/admin/assets/images/products/product-mini-2.jpg"
													alt="" />
											</div>
								...
								<tr>
									...
									<td>
										<div class="product">
											<div class="image">
												<img
													src="${contextPath}/templates/admin/assets/images/products/product-mini-3.jpg"
													alt="" />
											</div>
								...
								<tr>
									...
									<td>
										<div class="product">
											<div class="image">
												<img
													src="${contextPath}/templates/admin/assets/images/products/product-mini-4.jpg"
													alt="" />
											</div>
			...
			<div class="col-lg-7">
				<div class="card-style mb-30">
					...
					<div class="chart">
							...
							<ul class="legend3 d-flex flex-wrap align-items-center mb-30">
								<li>
									<div class="d-flex">
										...
										<div class="text">
											<p class="text-sm text-success">
												<span class="text-dark">Revenue</span> +25.55% <i
													class="lni lni-arrow-up"></i>
											</p>
										</div>
									</div>
								</li>
								<li>
									<div class="d-flex">
										...
										<div class="text">
											<p class="text-sm text-success">
												<span class="text-dark">Net Profit</span> +45.55% <i
													class="lni lni-arrow-up"></i>
											</p>
										</div>
									</div>
								...
								<li>
									<div class="d-flex">
										...
										<div class="text">
											<p class="text-sm text-danger">
												<span class="text-dark">Order</span> -4.2% <i
													class="lni lni-arrow-down"></i>
											</p>
										</div>
									</div>
								</li>
						...
						<canvas id="Chart3"
							style="width: 719px; height: 617px; margin-left: -35px; display: block; box-sizing: border-box;"
							width="719" height="617"></canvas>
					</div>
				</div>
			</div>
			<!-- End Col -->
			<div class="col-lg-5">
				<div class="card-style mb-30">
					...
					<div class="chart">
							...
							<ul
								...
								<li>
									<div class="d-flex">
										...
										<div class="text">
											<p class="text-sm text-success">
												<span class="text-dark">Store Visits</span> +25.55% <i
													class="lni lni-arrow-up"></i>
											</p>
											<h2>3456</h2>
										</div>
								...
								<li>
									<div class="d-flex">
										...
										<div class="text">
											<p class="text-sm text-danger">
												<span class="text-dark">Visitors</span> -2.05% <i
													class="lni lni-arrow-down"></i>
											</p>
											<h2>3456</h2>
										</div>
						...
						<canvas id="Chart4"
							style="width: 719px; height: 862px; margin-left: -35px; display: block; box-sizing: border-box;"
							width="719" height="862"></canvas>
					</div>
					<!-- End Chart -->
				</div>
			</div>
													...
													<div class="fc-scroller fc-scroller-liquid-absolute"
														...
														<div class="fc-daygrid-body fc-daygrid-body-unbalanced"
															...
															<table role="presentation"
																...
																style="width: 538px; height: 356px">
																<colgroup></colgroup>
																	...
																	<tr role="row">
																		<td aria-labelledby="fc-dom-2" role="gridcell"
																			...
																			<div
																				...
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 1, 2024" id="fc-dom-2"
																		...
																		<td aria-labelledby="fc-dom-4" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 2, 2024" id="fc-dom-4"
																		...
																		<td aria-labelledby="fc-dom-6" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 3, 2024" id="fc-dom-6"
																		...
																		<td aria-labelledby="fc-dom-8" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 4, 2024" id="fc-dom-8"
																		...
																		<td aria-labelledby="fc-dom-10" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 5, 2024" id="fc-dom-10"
																		...
																		<td aria-labelledby="fc-dom-12" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 6, 2024" id="fc-dom-12"
																		...
																		<td aria-labelledby="fc-dom-14" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 7, 2024" id="fc-dom-14"
																	...
																	<tr role="row">
																		<td aria-labelledby="fc-dom-16" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 8, 2024" id="fc-dom-16"
																		...
																		<td aria-labelledby="fc-dom-18" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 9, 2024" id="fc-dom-18"
																		...
																		<td aria-labelledby="fc-dom-20" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 10, 2024" id="fc-dom-20"
																		...
																		<td aria-labelledby="fc-dom-22" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 11, 2024" id="fc-dom-22"
																		...
																		<td aria-labelledby="fc-dom-24" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 12, 2024" id="fc-dom-24"
																		...
																		<td aria-labelledby="fc-dom-26" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 13, 2024" id="fc-dom-26"
																		...
																		<td aria-labelledby="fc-dom-28" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 14, 2024" id="fc-dom-28"
																	...
																	<tr role="row">
																		<td aria-labelledby="fc-dom-30" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 15, 2024" id="fc-dom-30"
																		...
																		<td aria-labelledby="fc-dom-32" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 16, 2024" id="fc-dom-32"
																		...
																		<td aria-labelledby="fc-dom-34" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 17, 2024" id="fc-dom-34"
																		...
																		<td aria-labelledby="fc-dom-36" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 18, 2024" id="fc-dom-36"
																		...
																		<td aria-labelledby="fc-dom-38" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 19, 2024" id="fc-dom-38"
																		...
																		<td aria-labelledby="fc-dom-40" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 20, 2024" id="fc-dom-40"
																		...
																		<td aria-labelledby="fc-dom-42" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 21, 2024" id="fc-dom-42"
																	...
																	<tr role="row">
																		<td aria-labelledby="fc-dom-44" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 22, 2024" id="fc-dom-44"
																		...
																		<td aria-labelledby="fc-dom-46" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 23, 2024" id="fc-dom-46"
																		...
																		<td aria-labelledby="fc-dom-48" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 24, 2024" id="fc-dom-48"
																		...
																		<td aria-labelledby="fc-dom-50" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 25, 2024" id="fc-dom-50"
																		...
																		<td aria-labelledby="fc-dom-52" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 26, 2024" id="fc-dom-52"
																		...
																		<td aria-labelledby="fc-dom-54" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 27, 2024" id="fc-dom-54"
																		...
																		<td aria-labelledby="fc-dom-56" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 28, 2024" id="fc-dom-56"
																	...
																	<tr role="row">
																		<td aria-labelledby="fc-dom-58" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 29, 2024" id="fc-dom-58"
																		...
																		<td aria-labelledby="fc-dom-60" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="September 30, 2024" id="fc-dom-60"
																		...
																		<td aria-labelledby="fc-dom-62" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 1, 2024" id="fc-dom-62"
																						class="fc-daygrid-day-number">1</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-64" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 2, 2024" id="fc-dom-64"
																						class="fc-daygrid-day-number">2</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-66" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 3, 2024" id="fc-dom-66"
																						class="fc-daygrid-day-number">3</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-68" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 4, 2024" id="fc-dom-68"
																						class="fc-daygrid-day-number">4</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-70" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 5, 2024" id="fc-dom-70"
																						class="fc-daygrid-day-number">5</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																	...
																	<tr role="row">
																		<td aria-labelledby="fc-dom-72" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 6, 2024" id="fc-dom-72"
																						class="fc-daygrid-day-number">6</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-74" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 7, 2024" id="fc-dom-74"
																						class="fc-daygrid-day-number">7</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-76" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 8, 2024" id="fc-dom-76"
																						class="fc-daygrid-day-number">8</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-78" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 9, 2024" id="fc-dom-78"
																						class="fc-daygrid-day-number">9</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-80" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 10, 2024" id="fc-dom-80"
																						class="fc-daygrid-day-number">10</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-82" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 11, 2024" id="fc-dom-82"
																						class="fc-daygrid-day-number">11</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
																		...
																		<td aria-labelledby="fc-dom-84" role="gridcell"
																			...
																			<div
																				class="fc-daygrid-day-frame fc-scrollgrid-sync-inner">
																				<div class="fc-daygrid-day-top">
																					<a aria-label="October 12, 2024" id="fc-dom-84"
																						class="fc-daygrid-day-number">12</a>
																				</div>
																				<div class="fc-daygrid-day-events">
																					<div class="fc-daygrid-day-bottom"
						...
						<table class="table top-selling-table">
							...
							<tbody>
								<tr>
									...
									<td><span class="status-btn close-btn">Pending</span></td>
									<td>
										<div class="action justify-content-end">
											<button class="edit">
								...
								<tr>
									...
									<td><span class="status-btn warning-btn">Refund</span></td>
									<td>
										<div class="action justify-content-end">
											<button class="edit">
												<i class="lni lni-pencil"></i>
								...
								<tr>
									...
									<td><span class="status-btn success-btn">Completed</span>
									</td>
									<td>
										<div class="action justify-content-end">
											<button class="edit">
								...
								<tr>
									...
									<td><span class="status-btn close-btn">Canceled</span></td>
									<td>
										<div class="action justify-content-end">
											<button class="edit">
												<i class="lni lni-pencil"></i>
