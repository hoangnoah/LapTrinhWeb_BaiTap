                      ...
                      <path
						...
						<ul class="dropdown-menu dropdown-menu-end"
							...
							<li><a href="#0">
									...
									<div class="content">
										<h6>
											John Doe <span class="text-regular"> comment on a
												product. </span>
										</h6>
							...
							<li><a href="#0">
									...
									<div class="content">
										<h6>
											Jonathon <span class="text-regular"> like on a
												product. </span>
										</h6>
										<p>Lorem ipsum dolor sit amet, consect etur adipiscing
											elit Vivamus tortor.</p>
					...
					<div class="profile-box ml-15">
						<button class="dropdown-toggle bg-transparent border-0"
							...
							<div class="profile-info">
								<div class="info">
									<div class="image">
										<img src="${URL}/assets/images/profile/profile-image.png"
											alt="" />
									</div>
									<div>
						...
						<ul class="dropdown-menu dropdown-menu-end"
							...
							<li class="divider"></li>
							<li><a href="#0"> <i class="lni lni-user"></i> View
									Profile
							</a></li>
							<li><a href="#0"> <i class="lni lni-alarm"></i>
									Notifications
							</a></li>
							<li><a href="#0"> <i class="lni lni-inbox"></i> Messages
							</a></li>
							<li><a href="#0"> <i class="lni lni-cog"></i> Settings
							</a></li>
							<li class="divider"></li>
							<li><a href="#0"> <i class="lni lni-exit"></i> Sign Out
							</a></li>
						</ul>
					</div>
					<!-- profile end -->
